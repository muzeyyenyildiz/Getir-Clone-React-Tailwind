  ...
  return (
    <>
      <div className="bg-brand-color">
        <div className="container h-16 md:h-11 mx-auto flex items-center justify-center md:justify-between">
          <a href="#">
          ...
          <nav className="hidden md:flex gap-x-8 text-sm font-semibold">
            <a
              href="#"
              className="text-white text-opacity-80 transition-all hover:text-opacity-100 flex items-center gap-x-2"
            >
              <BiGlobe size={20} />
              Türkçe (TR)
            </a>
      ...
      <div className=" md:hidden container mx-auto h-10 px-3  flex items-center justify-between ">
